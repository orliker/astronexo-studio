...
export const SCENARIOS = [
  {
    title: "Restaurantes",
    subtitle: "Automatización de reservas vía WhatsApp + Menú QR",
    desc: "El comensal escanea el QR, ve la carta y reserva mesa o pide delivery chateando. El bot verifica disponibilidad y confirma en segundos.",
    tag: "Respuesta inmediata (IA < 1 min)"
  },
  {
    title: "Clínicas & Estética",
    subtitle: "Bot de calificación de leads + Agendamiento",
    desc: "Cualifica al paciente según su dolor o tratamiento de interés y le asigna una cita en el calendario del doctor de forma automática.",
    tag: "Ruta de contacto directa"
  },
  {
    title: "Servicios Locales",
    subtitle: "Reactivación de clientes + SEO Local",
    desc: "Reconecta con antiguos contactos mediante campañas conversacionales automatizadas en WhatsApp, liberando tiempo administrativo.",
